...
saguaro.addEventListener("click", function () {
    ...
    var ans = {
        laura: {
            name: "<p>1 Name:</p> Laura"
            , question1: "<p>2 So, what's your favorite National Park?</p> Saguaro National Park"
...
$("#saguaro").on("click", function () {  //show "x"
    $("#a.modalclose").css('display', 'inline');
});
...
$("#boxclose").on("click", function () {  //removes overlay
 ...
 var list = document.querySelector(".icon");
      list.addEventListener("click", function(event) {
        console.log(ans[event.target.id]);
          document.querySelector("#nombre").textContent = ans[event.target.id].question1;
      });
